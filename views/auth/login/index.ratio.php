...
{% block body %}
    <form action="{{ route('auth.login.create') }}" method="post"  class="w-full bg-white mx-3 max-w-md py-6 px-6 rounded-lg shadow-md">
      <header class="flex justify-between items-center mb-3.5">
        <h1 class="text-2xl">Logga in</h1>
      ...
      <div class="relative mt-6 mb-2">
        <button class="text-sm w-full whitespace-nowrap py-2 px-3 border border-blue-600 bg-blue-600 hover:bg-blue-700 hover:border-blue-700  transition-all duration-300 text-white rounded-lg cursor-pointer">Logga in</button>
